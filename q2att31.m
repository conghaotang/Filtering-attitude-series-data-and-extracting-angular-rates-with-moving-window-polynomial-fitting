...
%     att = m2att(q2mat(qnb));
    ...
    C12 = 2*(q12 + q34); %2*(q23-q14); ÎªÊ²Ã´ÊÇ+ºÅ
    C22= q44-q11+q22-q33; %    q11-q22+q33-q44;
    C31= 2*(q13 + q24 ); % 2*(q24-q13); 
    C32=2*( q23 - q14 ); %2*(q34+q12); 
    C33= q44-q11-q22+q33; %q11-q22-q33+q44;
