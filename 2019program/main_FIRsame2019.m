...
randn('state',1000); %0  1e+03   2.11e+05  2.1041705 2.10414e+05
...
[rmse, STD, Meanz, maxz,minz] = accuracy (alfa_y2(:,n+1:end));
 acc=[rmse, STD, Meanz, maxz,minz];
 
 [rmse_y, STD_y, Meanz_y, maxz_y,minz_y] = accuracy (alfa_y(:,n+1:end));
